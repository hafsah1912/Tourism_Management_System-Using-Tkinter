-- Creating Database
CREATE DATABASE IF NOT EXISTS projectTTMS;
USE projectTTMS;
...
VALUES 
('1', 'Hunza Valley Tour', 'Experience the beauty of Hunza with our comprehensive tour package', '5000', 7),
...
VALUES 
('1', 'John Smith', 'john.smith@gmail.com', '123-456-7890'),
...
VALUES 
('1', 'Hotel Crown Plaza', 'in the heart of Islamabad', 'Islamabad', 7.1),
('2', 'Shelton Hotel Johar Town', 'The hotel features elegant rooms', 'Lahore Pakistan', 3.0),
('3', 'Swat View Hotel', 'The hotel features a garden a restaurant a terrace', 'Swat Pakistan', 6.8),
...
VALUES 
('1', 'Hunza Valley', 'Mountainous Valley', 'Gilgit Baltistan', 'Exotic place'),
...
VALUES 
('1', '1', '1', '1', '1', '2022-01-01', '5000', 'Confirmed'),
